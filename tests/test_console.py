...
class TestHBNBCommand(unittest.TestCase):
    """Definition of HBNBCommand test class."""
    ...
    def test_console_v_0_1(self):
        ...
        with patch('sys.stdout', new=StringIO()) as cout:
            ...
            clear_stream(cout)
            cons.onecmd('update BaseModel 12facc9a-451c-11b6-565505c55907')
    ...
    def test_class_show(self):
        """
            ...
            By creating and displaying sample object
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            cons.onecmd('create City')
    ...
    def test_class_destroy(self):
        """
            ...
            By creating and destroying a sample object
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            cons.onecmd('create City')
    ...
    def test_class_update_0(self):
        """
            ...
            By passing value to sample object
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_class_update_1(self):
        """
            ...
            creates and tests sample objects
